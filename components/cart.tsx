...
//       message += `• ${item.name} x${
//         item.quantity
//       } - ₦${discountedPrice.toLocaleString()} (20% off)\n`;
//     });
...
//   // Calculate with 20% discount applied to products only
//   const calculateProductsTotal = () => {
//     return cart.reduce((total, item) => {
//       const originalPrice = parseFloat(item.price.replace(/[₦,]/g, "")) || 0;
//       const discountedPrice = originalPrice * 0.8; // 20% off
//       return total + discountedPrice * item.quantity;
//     }, 0);
//   };

//   const calculateOriginalProductsTotal = () => {
//     return cart.reduce((total, item) => {
//       const price = parseFloat(item.price.replace(/[₦,]/g, "")) || 0;
//       return total + price * item.quantity;
//     }, 0);
...
//   const originalProductsTotal = calculateOriginalProductsTotal();
//   const productsTotal = calculateProductsTotal();
//   const discountAmount = originalProductsTotal - productsTotal;
//   const deliveryFee = getDeliveryFee();
//   const grandTotal = productsTotal + deliveryFee;
