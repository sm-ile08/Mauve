...
export function CartPage() {
  ...
  const handleBankTransferOrder = async () => {
    ...
    try {
      ...
      if (result.order && result.order.order_code) {
      ...
      if (error.name === "AbortError") {
        userMessage +=
          "Request timed out. The server might be waking up. Please try again in a few seconds.";
      } else if (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-2xl animate-fade-in">
            ...
            <button
              ...
              className="w-full mt-3 bg-green-600 text-white py-3 rounded-full font-semibold hover:bg-green-700 transition-all duration-300"
            >
